    ...
    <body>
        <!-- Header -->
            <section class="header" id="head">
                ...
                <div class="text-box">
                    ...
                    {{-- <a href="" class="hero-btn">Visitez-nous</a> --}}
                </div>
                <div>
        ...
        {{-- <!--Courses-->
            <section class="cours" id="cours">
                ...
                <div class="row">
                    <div class="cours-col">
                        <img src="{{ asset('img/taekwondo.jpg') }}" alt="">
                        <h3>Taekwondo</h3>
                    </div>
                    <div class="cours-col">
                        <img src="{{ asset('img/gymnastique.jpg') }}" alt="">
                        <h3>Gymnastique</h3>
                    </div>
                    <div class="cours-col">
                        <img src="{{ asset('img/jiu-jitsu.jpg') }}" alt="">
                        <h3>Jiu-jitsu</h3>
                    </div>
                </div>
            </section>
                ...
                <div class="about-wrap">
                    <div class="about-container">
                        ...
                        <div class="image-section">
                            <img src="{{ asset('img/salle.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </section>
        ...
        <!-- Footer -->
            <section class="footer">
                {{-- <div class="footer-content">
                    <a><img src="{{ asset('img/logo-dark.png') }}" alt=""></a>
                    <ul class="socials">
                ...
                <div class="footer-bottom">
                    <p>Log Systemes Consulting &copy;{{ date('Y') }}. <br>designed by <span>Rym Mohamed</span></p>
                </div>
            </section>
        <!-- FooterEnd -->
    </body>
