...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} des {{ trans('cruds.subscription.title') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Subscription">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.subscription.fields.member') }}
                        </th>
                        <th>
                            {{ trans('cruds.subscription.fields.package') }}
                        </th>
                        <th>
                            {{ trans('cruds.subscription.fields.debut') }}
                        </th>
                        <th>
                            {{ trans('cruds.subscription.fields.fin') }}
                        </th>
                        <th>
                            {{ trans('cruds.subscription.fields.state') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
