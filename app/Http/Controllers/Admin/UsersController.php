...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.users.create', compact('roles', 'courses', 'packages'));
    }
    ...
    public function edit(User $user)
    {
        ...
        $user->load('roles', 'course', 'package');

        return view('admin.users.edit', compact('roles', 'courses', 'packages', 'user'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'course', 'coachSessions', 'package');
