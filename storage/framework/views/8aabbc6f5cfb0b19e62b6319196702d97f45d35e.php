...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar" style="background: #02131a; border: none;">
        <button class="navbar-toggler sidebar-toggler d-lg-none mr-auto" type="button" data-toggle="sidebar-show">
            <span class="navbar-toggler-icon"></span>
        </button>
        <a class="navbar-brand" href="/">
          <span class="navbar-brand-full">
            <img src="<?php echo e(asset('img/pfe.png')); ?>" alt="" height="70%" width="55%" style="margin-left: 15px">
          </span>
          <span class="navbar-brand-minimized">
            <img src="<?php echo e(asset('img/logo1.png')); ?>" alt="" height="70%" width="70%" style="margin-left: 10px">
          </span>
  ...
  let languages = {
    'fr': "//cdn.datatables.net/plug-ins/1.10.22/i18n/French.json"
  };
...
<?php /**PATH C:\laragon\www\Laravel-School-Timetable-Calendar-master\resources\views/layouts/admin.blade.php ENDPATH**/ ?>