...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.session.title_singular')); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.sessions.update", [$session->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('course') ? 'is-invalid' : ''); ?>" name="course_id" id="course_id" required>
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e(($session->course ? $session->course->id : old('course_id')) == $id ? 'selected' : ''); ?>><?php echo e($course); ?></option>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('coach') ? 'is-invalid' : ''); ?>" name="coach_id" id="coach_id" required>
                    <?php $__currentLoopData = $coaches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $coach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e(($session->coach ? $session->coach->id : old('coach_id')) == $id ? 'selected' : ''); ?>><?php echo e($coach); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('weekday') ? 'is-invalid' : ''); ?>" type="number" name="weekday" id="weekday" value="<?php echo e(old('weekday', $session->weekday)); ?>" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control session-timepicker <?php echo e($errors->has('start_time') ? 'is-invalid' : ''); ?>" type="text" name="start_time" id="start_time" value="<?php echo e(old('start_time', $session->start_time)); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control session-timepicker <?php echo e($errors->has('end_time') ? 'is-invalid' : ''); ?>" type="text" name="end_time" id="end_time" value="<?php echo e(old('end_time', $session->end_time)); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel-School-Timetable-Calendar-master\resources\views/admin/sessions/edit.blade.php ENDPATH**/ ?>