...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.create')); ?> <?php echo e(trans('cruds.package.title_singular')); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.packages.store")); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('duration') ? 'is-invalid' : ''); ?>" type="text" name="duration" id="duration" value="<?php echo e(old('duration', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('price') ? 'is-invalid' : ''); ?>" type="text" name="price" id="price" value="<?php echo e(old('price', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('courses') ? 'is-invalid' : ''); ?>" name="courses[]" id="courses" multiple required>
                    ...
                    <option value="<?php echo e($id); ?>" <?php echo e(in_array($id, old('courses', [])) ? 'selected' : ''); ?>><?php echo e($courses); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel-School-Timetable-Calendar-master\resources\views/admin/packages/create.blade.php ENDPATH**/ ?>