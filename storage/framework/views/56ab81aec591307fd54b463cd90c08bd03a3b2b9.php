...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-success" href="<?php echo e(route("admin.users.create")); ?>?coach">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.coach.title_singular')); ?>

            </a>
            <a class="btn btn-success" href="<?php echo e(route("admin.users.create")); ?>?member">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.member.title_singular')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.list')); ?> des <?php echo e(trans('cruds.user.title')); ?>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.course.fields.package')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\FA-Manager\resources\views/admin/users/index.blade.php ENDPATH**/ ?>