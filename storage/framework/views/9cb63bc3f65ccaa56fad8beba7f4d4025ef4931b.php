    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-success" href="<?php echo e(route("admin.users.create")); ?>?member">
                <?php echo e(trans('global.add')); ?> Nouvel Adhérent
            </a>
        </div>
    </div>
<?php endif; ?>
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.list')); ?> de <?php echo e(trans('cruds.user.title_singular')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel-School-Timetable-Calendar-master\resources\views/admin/users/index.blade.php ENDPATH**/ ?>