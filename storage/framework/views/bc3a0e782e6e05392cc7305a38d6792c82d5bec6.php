...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.roles.store")); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="permissions"><?php echo e(trans('cruds.role.fields.permissions')); ?></label>
                ...
                <select class="form-control select2 <?php echo e($errors->has('permissions') ? 'is-invalid' : ''); ?>" name="permissions[]" id="permissions" multiple >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\FA-Manager\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>