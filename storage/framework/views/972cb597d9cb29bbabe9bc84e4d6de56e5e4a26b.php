    ...
    <body>
        ...
        <!-- Packages -->
            <section class="packages" id="packages">
                ...
                <div class="row">
                    ...
                    <div class="packages-col">
                        <h3>Kids Pack</h3>
                        <p>Dance ou Gymnastique</p>
                        <p><b>+</b></p>
                        <p>Taekwondo ou Kungfu</p>
                        <p><b>+</b></p>
                        <p>Psychomotricité</p>
                        <h4>70Dt / 3 mois</h4>
                        <a href="" class="btn">S'abonner</a>
        ...
        <!--Courses-->
            <section class="cours" id="cours">
                ...
                <div class="row">
                    <div class="cours-col">
                        <img src="<?php echo e(asset('img/taekwondo.jpg')); ?>" alt="">
                        <h3>Taekwondo</h3>
                        
                    </div>
                    <div class="cours-col">
                        <img src="<?php echo e(asset('img/gymnastique.jpg')); ?>" alt="">
                        <h3>Gymnastique</h3>
                        
                    </div>
                    <div class="cours-col">
                        <img src="<?php echo e(asset('img/jiu-jitsu.jpg')); ?>" alt="">
                        <h3>Jiu-jitsu</h3>
                    ...
                    <div class="about-container">
                        <div class="content-section">
                            ...
                            <div class="content">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate hic dicta, esse, quasi unde enim rerum nulla magnam voluptas illum quam facere rem saepe cum, dolores nostrum! Exercitationem, reiciendis doloremque!
                                </p>
...
</html><?php /**PATH C:\laragon\www\Laravel-School-Timetable-Calendar-master\resources\views//welcome.blade.php ENDPATH**/ ?>