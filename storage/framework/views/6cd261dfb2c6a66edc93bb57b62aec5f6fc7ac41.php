...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.list')); ?> de <?php echo e(trans('cruds.subscription.title_singular')); ?>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Subscription">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.subscription.fields.member')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.subscription.fields.package')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.subscription.fields.debut')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.subscription.fields.fin')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.subscription.fields.state')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($subscription->id); ?>">
                            ...
                            <td>
                                <?php echo e($subscription->member->name ?? ''); ?>
                            ...
                            <td>
                                <?php echo e($subscription->fin ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($subscription->state ?? ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\FA-Manager\resources\views/admin/subscriptions/index.blade.php ENDPATH**/ ?>